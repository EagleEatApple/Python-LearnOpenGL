...
class CubemapsEnvironmentMapping(CameraWindow):
    ...
    def init(self) -> None:
        ...
        # ------------------------------------
        self.shader = ProgramVF("shaders/4/6.2.cubemaps.vs",
                                "shaders/4/6.2.cubemaps.fs")

        self.skyboxShader = ProgramVF("shaders/4/6.2.skybox.vs",
                                "shaders/4/6.2.skybox.fs")
        ...
        self.cubeVAO.setVertexBuffer(self.cubeVBO, 0, 0, 6 * sizeof(GLfloat))
        ...
        # ---------------------
        self.shader.use()
        self.shader.setUniform1i("skybox", 0)
    ...
    def render(self) -> None:
        ...
        self.shader.setUniform3fv("cameraPos", self.camera.position)
        # cubes
        self.cubeVAO.bind()
...
if __name__ == "__main__":
    app = App()
    win = CubemapsEnvironmentMapping(title="Hello, Cubemap!")
    app.run(win)
