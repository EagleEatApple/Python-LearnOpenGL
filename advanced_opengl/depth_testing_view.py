...
class DepthTestingView(CameraWindow):
    ...
    def init(self) -> None:
        ...
        # ------------------------------------
        self.shader = ProgramVF("shaders/4/1.2.depth_testing.vs",
                                "shaders/4/1.2.depth_testing.fs")
...
if __name__ == "__main__":
    app = App()
    win = DepthTestingView(title="Hello, Depth tesing!")
    app.run(win)