...
class LightingTextured(CameraWindow):
    ...
    def init(self) -> None:
        ...
        # ------------------------------------
        self.shader = ProgramVF("shaders/6/1.2.pbr.vs",
                                "shaders/6/1.2.pbr.fs")
        ...
        # ---------------------
        self.shader.use()
        self.shader.setUniform1i("albedoMap", 0)
        self.shader.setUniform1i("normalMap", 1)
        self.shader.setUniform1i("metallicMap", 2)
        self.shader.setUniform1i("roughnessMap", 3)
        self.shader.setUniform1i("aoMap", 4)

        # load PBR material textures
        # --------------------------
        self.albedo    = ImageTexture2D("textures/pbr/rusted_iron/albedo.png")
        self.normal    = ImageTexture2D("textures/pbr/rusted_iron/normal.png")
        self.metallic  = ImageTexture2D("textures/pbr/rusted_iron/metallic.png")
        self.roughness = ImageTexture2D("textures/pbr/rusted_iron/roughness.png")
        self.ao        = ImageTexture2D("textures/pbr/rusted_iron/ao.png")
...
if __name__ == "__main__":
    app = App()
    win = LightingTextured(title="Hello, Lighing!")
    app.run(win)