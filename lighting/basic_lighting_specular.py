...
class BasicLightingSpecular(CameraWindow):
    ...
    def init(self) -> None:
        ...
        self.lightingShader = ProgramVF("shaders/2/2.2.basic_lighting.vs", 
                                   "shaders/2/2.2.basic_lighting.fs")

        self.lightCubeShader = ProgramVF("shaders/2/2.2.light_cube.vs", 
                                   "shaders/2/2.2.light_cube.fs")
...
if __name__ == "__main__":
    app = App()
    win = BasicLightingSpecular(title="Hello, Light!")
    app.run(win)    