...
class LightCastersDirectional(CameraWindow):
    ...
    def init(self) -> None:
        ...
        # ------------------------------------
        self.lightingShader = ProgramVF("shaders/2/5.1.light_casters.vs", "shaders/2/5.1.light_casters.fs")
        self.lightCubeShader = ProgramVF("shaders/2/5.1.light_cube.vs", "shaders/2/5.1.light_cube.fs")
    ...
    def render(self) -> None:
        ...
        self.lightingShader.use()
        self.lightingShader.setUniform3f("light.direction", -0.2, -1.0, -0.3)
...
if __name__ == "__main__":
    app = App()
    win = LightCastersDirectional(title="Hello, Light!")
    app.run(win)