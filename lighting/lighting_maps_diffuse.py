...
class LightingMapsDiffuse(CameraWindow):
    ...
    def init(self) -> None:
        ...
        self.lightingShader = ProgramVF("shaders/2/4.1.lighting_maps.vs", 
                                   "shaders/2/4.1.lighting_maps.fs")

        self.lightCubeShader = ProgramVF("shaders/2/4.1.light_cube.vs", 
                                   "shaders/2/4.1.light_cube.fs")
...
if __name__ == "__main__":
    app = App()
    win = LightingMapsDiffuse(title="Hello, Light!")
    app.run(win)