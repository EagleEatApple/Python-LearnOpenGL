...
class LightCastersPoint(CameraWindow):
    ...
    def init(self) -> None:
        ...
        # ------------------------------------
        self.lightingShader = ProgramVF("shaders/2/5.2.light_casters.vs", "shaders/2/5.2.light_casters.fs")

        self.lightCubeShader = ProgramVF("shaders/2/5.2.light_cube.vs", "shaders/2/5.2.light_cube.fs")
...
if __name__ == "__main__":
    app = App()
    win = LightCastersPoint(title="Hello, light!")
    app.run(win)