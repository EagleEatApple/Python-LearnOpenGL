...
class Transformations(GLWindow):
    def init(self) -> None:
        # build and compile our shader program
        # ------------------------------------

        self.ourShader = ProgramVF("shaders/1/5.1.transform.vs", 
                                   "shaders/1/5.1.transform.fs")
    ...
    def render(self) -> None:
        ...
        self.ourShader.use()
        self.ourShader.setUniformMatrix4fv("transform", transform)
...
if __name__ == "__main__":
    app = App()
    win = Transformations(title="Hello, Transformation!")
    app.run(win)