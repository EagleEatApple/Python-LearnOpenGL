...
class CoordinateSystemsMultiple(GLWindow):
    def init(self) -> None:
        ...
        # ------------------------------------
        self.ourShader = ProgramVF("shaders/1/6.3.coordinate_systems.vs", 
                                   "shaders/1/6.3.coordinate_systems.fs")
...
if __name__ == "__main__":
    app = App()
    win = CoordinateSystemsMultiple(title="Hello, Coordinate Systems Multiple!")
    app.run(win)