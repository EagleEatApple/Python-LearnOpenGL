...
class SteepParallaxMapping(CameraWindow):
    ...
    def init(self) -> None:
        ...
        # ------------------------------------
        self.shader = ProgramVF("shaders/5/5.2.parallax_mapping.vs",
                                "shaders/5/5.2.parallax_mapping.fs")
...
if __name__ == "__main__":
    app = App()
    win = SteepParallaxMapping(title="Hello, Parallax mapping!")
    app.run(win)